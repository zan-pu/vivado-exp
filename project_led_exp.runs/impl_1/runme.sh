...
HD_PWD='C:/Users/Garvey/Documents/Vivado/project_led_exp/project_led_exp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_exp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_exp.tcl -notrace
