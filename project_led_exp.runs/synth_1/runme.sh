...
HD_PWD='C:/Users/Garvey/Documents/Vivado/project_led_exp/project_led_exp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_exp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_exp.tcl
